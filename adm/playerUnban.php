...
<div class="container my-5">
        ...
        <div class="container">
            ...
            <div class="row py-3">
                <div class="col-xl-12 col-lg-12 col-md-12 px-5 text-white">
                    <h1>플레이어 밴(차단) 해제</h1>
                    <p class="text-lead">플레이어를 차단해제 할 수 있습니다.</p>
                </div>
            </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card shadow bg-secondary border-0 mb-0">
                    <div class="card-header bg-dark">
                        <h5 class="form-text fw-bold text-white">플레이어 차단(밴) 해제하기</h5>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        <form role="form" action="/lib/_admin.php" method="post">
                        <div class="form-group">
                                <span class="form-text h6 fw-bold text-light">차단 해제할 고유번호</span>
                            ...
                            <div class="form-group">
                                <span class="form-text h6 fw-bold text-light">차단 해제 사유</span>
								<div class="input-group input-group-merge input-group-alternative">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
                                    </div>
                                    <input class="form-control" name="reason" placeholder="차단 해제 사유를 입력하세요." type="text">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="button" class="btn btn-primary my-4" onclick="_post('req=unban&' + $(this.form).serialize());">차단 해제하기</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    function _post(data) {
        ...
        document.xhr = $.ajax({
            ...
            success:function(r){
                if (r.state == "success") {
                    alert(r.arr.nickname + "[" + r.arr.user_id + ']님을 게임에서 차단 해제하였습니다.');
                    location.reload();
